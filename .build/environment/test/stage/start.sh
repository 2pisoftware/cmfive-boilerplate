...
echo "zend_extension=xdebug.so" > /etc/php/7.2/fpm/conf.d/20-xdebug.ini \
	...
	&& echo "xdebug.client_host=${INTERNAL_HOST_IP}" >> /etc/php/7.2/fpm/conf.d/20-xdebug.ini \
	&& echo "xdebug.mode=debug"  >> /etc/php/7.2/fpm/conf.d/20-xdebug.ini \
	&& echo "xdebug.start_with_request=yes" >> /etc/php/7.2/fpm/conf.d/20-xdebug.ini \
	&& echo "xdebug.client_port=9000" >> /etc/php/7.2/fpm/conf.d/20-xdebug.ini
