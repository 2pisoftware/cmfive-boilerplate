...
export class FormHelper {
    ...
    static async addFormField(page: Page, form: string, name: string, key: string, type: string)
    {
        ...
        await page.waitForSelector("#cmfive-modal", {state: "visible"});     await page.waitForSelector("#cmfive-modal", {state: "visible"});
    ...
    static async attachApplicationForm(page, application: string, form: string)
    {
        await CmfiveHelper.clickCmfiveNavbar(page, "Form", "Applications");
